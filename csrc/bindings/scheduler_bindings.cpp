...
PYBIND11_MODULE(_C, m) {
  ...
  py::class_<BatchStepResult>(m, "BatchStepResult")
      ...
      .def_readwrite("total_batched_tokens",
                     &BatchStepResult::total_batched_tokens)
  ...
  py::class_<ContinuousBatcher>(m, "ContinuousBatcher")
      .def(py::init<size_t, size_t>(), py::arg("max_num_seqs"),
           py::arg("max_num_batched_tokens"))
      .def("add_request", &ContinuousBatcher::add_request, py::arg("request"))
      .def("cancel_request", &ContinuousBatcher::cancel_request,
           py::arg("request_id"))
      .def("schedule_step", &ContinuousBatcher::schedule_step)
      .def("update_requests_state", &ContinuousBatcher::update_requests_state,
           py::arg("finished_ids"))
